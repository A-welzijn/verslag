...
;angular.module('awelzijn.verslag').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('templates/verslag.html',
    ...
    "<span>Verslag toevoegen</span> </a> </div>"
  );
